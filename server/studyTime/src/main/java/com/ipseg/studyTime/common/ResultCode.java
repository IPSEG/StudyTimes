...
public enum ResultCode {
    ...
    ERROR_009("009", "아이디는 20자 이하여야 합니다."),
    ERROR_010("010","타이머 메모 생성 실패하였습니다"),
    ERROR_011("011", "아이디는 영문과 숫자 조합으로 4~20자로 생성해주세요."),
    ERROR_012("012", "이미 존재하는 아이디 입니다."),
    ERROR_013("013", "이름이 유효하지 않습니다.");
